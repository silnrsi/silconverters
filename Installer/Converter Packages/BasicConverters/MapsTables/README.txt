...
The Unicode 13.0 standard did not include any changes to SIL's  
Private Use Area. 

The Unicode 12.0 standard includes 1 additional character  
that was previously allocated to a codepoint in the Private Use Area 
by SIL's PUA committee. 

The Unicode 9.0, 10.0, and 11.0 standard did not include any changes to SIL's  
Private Use Area. 
...
TECkit library and tools:
	http://software.sil.org/teckit

SIL Converters package for MS Word:
	http://software.sil.org/silconverters
