...
namespace SIL.ParatextBackTranslationHelperPlugin
{
    internal class PtxPluginHelpers
    {
        ...
        public static string GetSourceAlternate(bool translateWithoutInterruption, List<IUSFMToken> tokens, List<IUSFMTextToken> textTokens, ref bool processingQs)
        {
            string sourceStringAlternate = null;
            if (translateWithoutInterruption)
            {
