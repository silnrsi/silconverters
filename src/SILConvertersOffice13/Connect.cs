...
namespace SILConvertersOffice13
{
	using System;
	using Extensibility;
    ...
    [GuidAttribute("9FDB0283-1795-4BF4-97E9-84223F3FC8EA"), ProgId("SILConvertersOffice13.Connect")]
	public class Connect : Object, IDTExtensibility2, IRibbonExtensibility
	{
        ...
        protected static void RegisterOfficeApp(RegistryKey keyComAddinRoot, string strOfficeApp, Type t)
        {
            ...
            if (keySubKey != null)
            {
                keySubKey.SetValue("Description", "Providing access to SILConverters in Office 2013 applications");
                keySubKey.SetValue("FriendlyName", "SILConverters for Microsoft Office 2013");
